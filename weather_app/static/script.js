const OPENWEATHERMAP_API_KEY = '4495bce352fee4102d92010b47e5484a';
        ...
        function aggregateDailyData(hourlyData) {
            ...
            return dailyData.slice(0, 10); // Limit to 10 days (though free API only provides 5 days)
        }
        ...
        function displayDailyForecast(dailyData) {
            ...
            // Take up to 10 days (limited by API plan)
            const next10Days = dailyData.slice(0, 10);
